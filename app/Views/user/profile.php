    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="profile-card text-center">
          ...
          <!-- <img src="../../public/halloween-scene-illustration-anime-style.jpg" alt="Avatar" class="rounded-circle mb-3" style="width: 150px; height: 150px;"> -->
      ...
      <div class="col-md-8">
        ...
        <div class="info-section mt-4">
          <ul class="list-group list-group-flush">
            <li class="list-group-item">Ваши имя: <strong><?= htmlspecialchars($user['username']) ?></strong></li>
